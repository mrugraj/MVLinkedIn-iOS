...
- (void)viewDidLoad {
    ...
    NSString *clientId = apikey; //the client secret you get from the registered LinkedIn application
    NSString *clientSecret = secretkey; //the client secret you get from the registered LinkedIn application
